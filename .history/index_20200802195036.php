  ...
  <div class="col">
    <div class="contenido">
      <div class="formulario">
        ...
        <label>Latidud:</label> <input type="text" name="latitud"><br>
        <label>Longitud: </label><input type="text" name="longitud"><br>
        <label>Facebook: </label><input type="text" name="facebook"><br>
        <label>Instagram: </label><input type="text" name="instagram"><br>
