function initMap() {
    ...
    downloadUrl('huecas.xml', function (data) {
        ...
        Array.prototype.forEach.call(huecas, function (markerElem) {
            ...
            infowincontent.append(text_telf, document.createElement('br'), 
                                    text_dir, document.createElement('br'),
                                    text_fb, document.createElement('br'),
                                    text_ins, document.createElement('br'),
                                    text_twi);
